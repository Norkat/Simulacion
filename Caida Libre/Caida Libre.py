...
tituloSimular = Label(
    frame_actual, text="Ingresa los datos a simular", font=("Arial", 25))
tituloSimular.pack()

labelM = Label(frame_actual, text="Peso:", font=40,
               width=30).pack(padx=10, pady=10)
mEntry = Entry(frame_actual)
mEntry.pack()

labelC = Label(frame_actual, text="Coeficiente de resistencia:",
               font=40, width=30).pack(padx=10, pady=10)
