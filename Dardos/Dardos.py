...
def generarNumeros(data):
    ...
    colors = ["blue", "red"]
    color_filt = []
    frameTabla = Frame(window, width=640, height=680)
...
def menu():
    limpiar_frame(window)
    frameActual = Frame(window, width=640, height=640)
    ...
    botonEnviar = Button(frameActual, text='Enviar entrada manual', command=lambda: [
