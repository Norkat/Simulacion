...
def generarTablaJ1(datosTablaJ1):
    limpiar_frame(window)
    frameJ1 = Frame(window, width=640, height=360)
    ...
    tablaJ1.column("#1", anchor="center", width=50)
    tablaJ1.column("#2", anchor="center", width=100)
    tablaJ1.column("#3", anchor="center", width=100)
    tablaJ1.column("#4", anchor="center", width=100)
    tablaJ1.column("#5", anchor="center", width=100)
    tablaJ1.column("#6", anchor="center", width=100)
    tablaJ1.column("#7", anchor="center", width=150)
    tablaJ1.column("#8", anchor="center", width=100)
    ...
    tablaJ1.heading(6, text="Ganó?")
    tablaJ1.heading(7, text="$Despues de girar")
    tablaJ1.heading(8, text="Se llegó a los $1000?")
...
def generarTablaJ2(datosTablaJ2):

    limpiar_frame(window)

    frameJ2 = Frame(window, width=640, height=360)
    ...
    tablaJ2.column("#1", anchor="center", width=50)
    tablaJ2.column("#2", anchor="center", width=100)
    tablaJ2.column("#3", anchor="center", width=100)
    tablaJ2.column("#4", anchor="center", width=100)
    tablaJ2.column("#5", anchor="center", width=100)
    tablaJ2.column("#6", anchor="center", width=100)
    tablaJ2.column("#7", anchor="center", width=150)
    tablaJ2.column("#8", anchor="center", width=100)
    ...
    tablaJ2.heading(6, text="Ganó?")
    tablaJ2.heading(7, text="$Despues de girar")
    tablaJ2.heading(8, text="Se llegó a los $1000?")
...
def generarApuestas(i):
    ...
    while sigueJugandoJ1 or sigueJugandoJ2:
        ...
        if dineroj2 >= 1000:
            datosTablaJ2.append(
                [it, dineroA2, apuestaj2, numRandom, color, ganoj2, dineroj2, "Si"])
            sigueJugandoJ2 = False
            canvas.itemconfig(txtApuestaJ2, text='Apuesta: 0')
        else:
            datosTablaJ2.append(
                [it, dineroA2, apuestaj2, numRandom, color, ganoj2, dineroj2, "No"])
            if dineroj2 <= 0:
                sigueJugandoJ2 = False
                canvas.itemconfig(txtApuestaJ2, text='Apuesta: 0')

    generarTablaJ1(datosTablaJ1)
    generarTablaJ2(datosTablaJ2)
