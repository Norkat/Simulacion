...
def menuHuecos():
    ...
    botonOpc1 = Button(fmenuHuecos, text='Tabla Huecos', command=opc1Huecos)
    botonOpc1.config(font=10, width=18, height=1)
    botonOpc1.pack(pady=10)
    
    botonOpc2 = Button(fmenuHuecos, text='Tabla de Chi2', command=opc2Huecos)
    botonOpc2.config(font=10, width=18, height=1)
    botonOpc2.pack(pady=10)
...
def frameErrorPoker():
    ...
    botonEnviar = Button(inputPoker, text='Enviar', 
